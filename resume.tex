...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Docker, Kubernetes, GitHub, GitHub Actions,  GitLab, Azure, AzureML, Azure DevOps, AWS, Linux, PowerBI, QGIS, CVAT} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Software Engineer}{Feb. 2023 -- Present}
      ...
      \resumeItemListStart
        \resumeItem{Sped up batch inference for a tax asset classifier by up to 80\% via integrating asychronous calls to OpenAI}  
        \resumeItem{Served PowerBI dashboards to over 10,000 NZ Police staff by building Spark pipelines in Azure Synapse Analytics}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Trained and deployed deep learning models which were presented by the CEO to more than 61,000 attendees at MWC 2022, NTT and Starbucks using PyTorch and Keras for model development and Flask for deployment}
